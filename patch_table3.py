...
# Find index of '<AnimatePresence mode="popLayout">'
start_idx = content.find('<AnimatePresence mode="popLayout">')
if start_idx == -1:
                  ...
                  <table className="w-full text-left border-collapse min-w-[500px]">
                    <thead>
                      <tr className="bg-gray-50 dark:bg-slate-800/50 border-b border-gray-200 dark:border-slate-800 text-gray-500 dark:text-slate-400 text-[13px] font-bold">
                        ...
                        <th className="px-4 py-3.5 w-28 text-right whitespace-nowrap">សកម្មភាព</th>
                      </tr>
                    </thead>
    ...
    # Let's verify end_tag actually ends the filteredRecords block.
    # The current code has one AnimatePresence mode="popLayout" which contains the map.
    # And it also has other AnimatePresence in the component. We just replace this specific one.
