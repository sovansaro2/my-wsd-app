...
async function run() {
  ...
  // The array is in the order we want it displayed.
  // The API sorts by created_at DESC (newest first).
  // So the first item in the array must have the NEWEST created_at.
  // We iterate through lines and subtract time to make subsequent items older.
  for (let i = 1; i < lines.length; i++) {
    ...
    // First line will have baseTime
    // Next line will have baseTime - 1000ms
    // etc.
