...
if start_idx == -1:
    ...
    replacement = """              {/* Records List */}
              <div className="px-4 sm:px-6 pb-28">
                {records.length === 0 ? (
                  <div className="text-center py-12 text-zinc-400 dark:text-slate-500 text-[15px]">មិនមានទិន្នន័យក្នុងសីលនេះទេ</div>
                ) : (
